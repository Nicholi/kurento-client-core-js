 ...
 *
 * @type {(UNKNOWN|TRANSCODING|NOT_TRANSCODING)}
 */
...
function checkMediaFlowState(key, value)
{
  ...
  if(!value.match('UNKNOWN|TRANSCODING|NOT_TRANSCODING'))
    throw SyntaxError(key+' param is not one of [UNKNOWN|TRANSCODING|NOT_TRANSCODING] ('+value+')');
};
